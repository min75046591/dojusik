...
export default function StockWebSocket() {
  // 상태값
  ...
  // 클라이언트 코드에서는 민감 정보(APP_KEY, APP_SECRET)를 직접 사용하지 않습니다.
  // 대신 내부 API 라우트가 승인키 요청을 처리합니다.
  const STOCK_CODE = '005930' // 예시: 삼성전자
  const HTS_ID = 'YOUR_HTSID'  // 체결통보용 HTS ID
  const CUSTTYPE = 'P'         // 개인: 'P', 법인: 'B'
  
  // 내부 API 라우트 URL: 파일이 app/api/detailchart/websocket/route.ts에 있으므로
